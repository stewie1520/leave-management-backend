...
import { LogOutCommandHandler } from './application/commands/logout/logout.command';
...
import { LogoutPostController } from './infrastructure/controllers/logout-post/logout-post.controller';
...
const controllers = [LoginPostController, LogoutPostController];
const commands = [LoginCommandHandler, LogOutCommandHandler];
