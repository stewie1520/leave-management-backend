...
export class Init1750215859127 implements MigrationInterface {
  name = 'Init1750215859127';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "leave_balance" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "totalDays" integer NOT NULL, "usedDays" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "employeeId" uuid, CONSTRAINT "REL_00328eee2460d74eec58f61bc5" UNIQUE ("employeeId"), CONSTRAINT "PK_3455e264c75148742540634aca2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."employee_role_enum" AS ENUM('STAFF', 'MANAGER')`,
    );
    await queryRunner.query(
      `CREATE TABLE "employee" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "role" "public"."employee_role_enum" NOT NULL DEFAULT 'STAFF', "accountId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "leave_balance" ADD CONSTRAINT "FK_00328eee2460d74eec58f61bc55" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "leave_balance" DROP CONSTRAINT "FK_00328eee2460d74eec58f61bc55"`,
    );
